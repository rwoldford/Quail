...
(defun dsidi-hook (a lda n kpvt det inert work job)
  ...
  (prog ((t_ 0.0) (temp 0.0) (akkp1 0.0) (akp1 0.0) (ak 0.0)
         (d 0.0) (kstep 0) (ks 0) (km1 0) (k 0) (jb 0) (j 0)
        ...
        (fdo (k 1 (+ k 1))
             ...
             (tagbody (setf d (fref a k k))
              ...
              label40 label50 (if noert (go label60))
                      (if (> d 0.0) (setf (fref inert 1) (+ (fref inert 1) 1)))
                      (if (< d 0.0) (setf (fref inert 2) (+ (fref inert 2) 1)))
                      (if (= d 0.0) (setf (fref inert 3) (+ (fref inert 3) 1)))
