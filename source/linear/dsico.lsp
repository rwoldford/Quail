...
(defun dsico-hook (a lda n kpvt rcond z)
  ...
  (prog ((t_ 0.0) (ek 0.0) (bkm1 0.0) (bk 0.0) (akm1 0.0) (ak 0.0)
         (ynorm 0.0) (s 0.0) (anorm 0.0) (ks 0) (kps 0) (kp 0) (k 0)
         (jm1 0) (j 0) (info (array 0 :dimensions 'nil)) (i 0) (denom 0.0))
   ...
   label110 (setf k (- k ks))
        (go label60)
   label120 (setf s (f2cl/ 1.0 (dasum-hook n z 1)))
        (dscal-hook n s z 1)
        (setf k 1)
   ...
   label140 label150 (setf k (+ k ks))
        (go label130)
   label160 (setf s (f2cl/ 1.0 (dasum-hook n z 1)))
        (dscal-hook n s z 1)
        (setf ynorm 1.0)
        (setf k n)
   ...
   label220 (setf k (+ k (- ks)))
        (go label170)
   label230 (setf s (f2cl/ 1.0 (dasum-hook n z 1)))
        (dscal-hook n s z 1)
        (setf ynorm (* s ynorm))
        (setf k 1)
   ...
   label250 label260 (setf k (+ k ks))
        (go label240)
   label270 (setf s (f2cl/ 1.0 (dasum-hook n z 1)))
        (dscal-hook n s z 1)
        (setf ynorm (* s ynorm))
