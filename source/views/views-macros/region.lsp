...
(eval-when (:compile-toplevel :load-toplevel :execute) (proclaim '(inline make-region)))
(defun make-region 
...
(eval-when (:compile-toplevel :load-toplevel :execute) (proclaim '(inline bounds-of)))

(defun bounds-of (region)
  (values (left-of region) (right-of region) (bottom-of region)
          (top-of region)))

(eval-when (:compile-toplevel :load-toplevel :execute) (proclaim '(inline valid-region-check)))
...
(eval-when (:compile-toplevel :load-toplevel :execute) (proclaim '(inline bottom-left-of bottom-right-of top-left-of
...
(eval-when (:compile-toplevel :load-toplevel :execute) (proclaim '(inline radius-of)))
